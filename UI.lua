...
function library:Introduction()
    ...
    while tick() - startTime < 3 do
        hashLogo.Rotation = hashLogo.Rotation + 10
        wait(0.01)
        end
    end
...
function library:Init(key)
    ...
    function TabLibrary:NewTab(title)
        ...
        function Components:NewSlider(text, suffix, compare, compareSign, values, callback)
            ...
            sliderIndicatorGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(115, 159, 255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(94, 128, 208))}
